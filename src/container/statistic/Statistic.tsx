...
function Statistic() {
	...
	// useEffect(() => {
	// 	statistic.StatisticalSummaryService().then(res => {
	// 		console.log(res)
	// 	})
	// }, [])
	...
	return (
		<Grid xs={12} container spacing={3}>
			...
			<Grid item xs={12} md={6} lg={3} xl={3}>
				<SummaryGeneral icon={iconCustomer} title='Tổng số khách hàng' value={totalCustomer} />
			</Grid>
			<Grid item xs={12} md={6} lg={3} xl={3}>
				<SummaryGeneral icon={iconTicket} title='Tổng số vé' value={totalTicket} />
			</Grid>
			<Grid item xs={12} md={6} lg={3} xl={3}>
				<SummaryGeneral icon={iconTrip} title='Tổng số chuyến đi' value={totalTrip} />
			</Grid>
			<Grid item xs={12} md={6} lg={3} xl={3}>
				<SummaryGeneral icon={iconRevenue} title='Tổng doanh thu' value={totalRevenue} isMoney={true} />
			</Grid>
